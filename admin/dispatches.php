...
// Fetching all dispatches for display
...
<body>
    ...
    <!-- Main content area -->
    <div class="content">
        <h1>Manage Dispatches</h1>
        <p><a href="add_dispatch.php">Add New Dispatch</a></p>
        <table>
            <tr>
                <th>ID</th>
                <th>Incident ID</th>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_dispatch.php?id=<?php echo $row['id']; ?>">Edit</a> |
                        <a href="delete_dispatch.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
