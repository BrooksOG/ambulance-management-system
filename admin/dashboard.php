<?php
// Including the database connection file from the includes folder
...
// Total number of driver trips (assignments)
$trips_query = "SELECT COUNT(*) as total FROM assignment_logs WHERE status = 'ASSIGNED'";
...
<body>
    ...
    <div class="content">
        ...
        <p>Admin dashboard to oversee the entire system.</p>
        ...
        <!-- Additional guidance for the admin -->
        <p>Use the sidebar to manage users, ambulances, drivers, paramedics, dispatches, incidents, assignments, generate reports, and manage inventory.</p>
    </div>
</body>
</html>